...
class CompletedEventView extends StatefulWidget {
  const CompletedEventView({super.key});

  @override
  State<CompletedEventView> createState() => _CompletedEventViewState();
}

class _CompletedEventViewState extends State<CompletedEventView> {
  ...
  void getEmployeeData() async {
    ...
    List oyput = guest.where((e)=> e.status==true).toList();
        ...
        Column(
          children: [
            ...
            Expanded(
              ...
              CustomText(
                customText: "No Completed Event Found",
                          ...
                          Row(
                            children: [
                              ...
                              Container(
                                ...
                                height: 25,
                                child: GFBadge(
                                  child: guest[index].status==true?Text("Completed"):Container(),
                                  shape: GFBadgeShape.standard,
                                  size: GFSize.LARGE,
